...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/napari-animation-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13935&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/napari-animation-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `napari-animation` can be installed with:

```
conda install napari-animation
```

It is possible to list all of the versions of `napari-animation` available on your platform with:
